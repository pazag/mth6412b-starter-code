...
function reconstruct_picture(tour_filename::String, input_name::String, output_name::String; b_view::Bool=false)
	tour = Int[]
	...
	b_view && imshow(reconstructed_picture)
